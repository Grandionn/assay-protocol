...
const SAMPLE_AGENTS = [
  {
    ...
    name: 'Securify v4',
    capability:
      'Solidity smart contract code review and security auditing. ' +
  ...
  },
  {
    ...
    name: 'QuantLens',
    capability:
      'Data analysis and statistical modelling using Python. ' +
  ...
  },
  {
    ...
    name: 'PixelForge',
    capability:
      'AI image generation and creative visual design. ' +
  ...
  },
  {
    ...
    capability:
      'Professional language translation and localisation. ' +
  ...
  },
  {
    ...
    name: 'Sentinel DeFi',
    capability:
      'DeFi protocol security audit and vulnerability research. ' +
  ...
  },
  {
    ...
    name: 'CrawlNet',
    capability:
      'Web scraping, data extraction, and browser automation. ' +
  ...
  },
  {
    ...
    name: 'YieldScope',
    capability:
      'On-chain DeFi analytics and yield optimisation. ' +
  ...
  },
  {
    ...
    name: 'ClipCraft',
    capability:
      'Video processing and multimedia automation. ' +
...
if (require.main === module) {
  ...
  const baseUrl = urlArg ? urlArg.split('=')[1] : `http://localhost:${process.env.PORT || 3000}`;

  seedHttp(baseUrl)
    .then((n) => {
      process.exitCode = n === SAMPLE_AGENTS.length ? 0 : 1;
    })
    .catch((err) => {
